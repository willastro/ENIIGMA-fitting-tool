...
def gamod(new_tau, etau, DIR1, DIR2, Stats='False', freq_stat = 10, gen=100, ga_min = 0., ga_max = 0.5, mutp = 0.01, popsize = 50, cc = 1.):
	"""
	...
	def cal_pop_fitness(pop):
	    ...
	    #fitness0 = numpy.sum(A)
	    fitness = f#numpy.sum(A)
	...
	def run_main(num_weights, ga_min = ga_min, ga_max = ga_max, Stat = Stats, freq = freq_stat, gen=gen, mutp = mutp, popsize = popsize, cc=cc):
	    # Genome instance
	    ...
	    genome.evaluator.set(cal_pop_fitness)
